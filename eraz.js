...
(function () {
  ...
  let __createBaseClipPathSVGMarkup = fabric.Object.prototype._createBaseClipPathSVGMarkup;
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    toObject: function (propertiesToInclude) {
      let object = _toObject.call(this, ['erasable'].concat(propertiesToInclude));
        ...
        eraser.clone(function (eraser) {
          ...
          eraser.getObjects('path').forEach(function (path) {
            ...
            if (clipPath) {
              clipPath.clone(
                function (_clipPath) {
                  let eraserPath = fabric.EraserBrush.prototype.applyClipPathToPath.call(
                    fabric.EraserBrush.prototype,
                    path,
                    _clipPath,
                    transform,
  ...
  fabric.EraserBrush = fabric.util.createClass(
    ...
    /** @lends fabric.EraserBrush.prototype */ {
      ...
      applyClipPathToPath: function (path, clipPath, clipPathContainerTransformMatrix) {
        let pathInvTransform = fabric.util.invertTransform(path.calcTransformMatrix());
